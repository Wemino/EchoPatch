...
static void ReadConfig()
{
    ...
    if (SDLGamepadSupport)
    {
        ...
        ConfigureGamepadHoldMappings(GAMEPAD_SOUTH_HOLD, GAMEPAD_SOUTH_HOLD_TIME, GAMEPAD_EAST_HOLD, GAMEPAD_EAST_HOLD_TIME, GAMEPAD_WEST_HOLD, GAMEPAD_WEST_HOLD_TIME, GAMEPAD_NORTH_HOLD, GAMEPAD_NORTH_HOLD_TIME, GAMEPAD_LEFT_STICK_HOLD, GAMEPAD_LEFT_STICK_HOLD_TIME, GAMEPAD_RIGHT_STICK_HOLD, GAMEPAD_RIGHT_STICK_HOLD_TIME, GAMEPAD_LEFT_SHOULDER_HOLD, GAMEPAD_LEFT_SHOULDER_HOLD_TIME, GAMEPAD_RIGHT_SHOULDER_HOLD, GAMEPAD_RIGHT_SHOULDER_HOLD_TIME, GAMEPAD_DPAD_UP_HOLD, GAMEPAD_DPAD_UP_HOLD_TIME, GAMEPAD_DPAD_DOWN_HOLD, GAMEPAD_DPAD_DOWN_HOLD_TIME, GAMEPAD_DPAD_LEFT_HOLD, GAMEPAD_DPAD_LEFT_HOLD_TIME, GAMEPAD_DPAD_RIGHT_HOLD, GAMEPAD_DPAD_RIGHT_HOLD_TIME, GAMEPAD_BACK_HOLD, GAMEPAD_BACK_HOLD_TIME, GAMEPAD_START_HOLD, GAMEPAD_START_HOLD_TIME, GAMEPAD_LEFT_TRIGGER_HOLD, GAMEPAD_LEFT_TRIGGER_HOLD_TIME, GAMEPAD_RIGHT_TRIGGER_HOLD, GAMEPAD_RIGHT_TRIGGER_HOLD_TIME, GAMEPAD_MISC1_HOLD, GAMEPAD_MISC1_HOLD_TIME, GAMEPAD_RIGHT_PADDLE1_HOLD, GAMEPAD_RIGHT_PADDLE1_HOLD_TIME, GAMEPAD_LEFT_PADDLE1_HOLD, GAMEPAD_LEFT_PADDLE1_HOLD_TIME, GAMEPAD_RIGHT_PADDLE2_HOLD, GAMEPAD_RIGHT_PADDLE2_HOLD_TIME, GAMEPAD_LEFT_PADDLE2_HOLD, GAMEPAD_LEFT_PADDLE2_HOLD_TIME);
    }
